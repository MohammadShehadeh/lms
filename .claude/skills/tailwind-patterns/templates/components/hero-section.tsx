      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground mb-8 leading-relaxed">
            Create beautiful, responsive web applications with production-ready Tailwind CSS patterns. Get started in
            minutes, not hours.
          </p>
    ...
    <section className="py-24 sm:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left: Content */}
          <div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">Build Faster with Tailwind Patterns</h1>
            <p className="text-lg text-muted-foreground mb-8">
              Production-ready components that work out of the box. Copy, paste, and customize to match your brand.
            </p>
          ...
          <div className="relative">
            <div className="aspect-square rounded-lg bg-muted overflow-hidden">
              <img src="/hero-image.jpg" alt="Product screenshot" className="w-full h-full object-cover" />
            </div>
            {/* Decorative elements */}
